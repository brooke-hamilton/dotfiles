...
A summary of what you did in the last 24 hours across GitHub, email, and Teams.

### GitHub Activity
{Insert "Your Activity (last 24h)" sections from each github-repo-reporter, in order. Omit repos where you had no personal activity.}

### Emails Sent
{Insert "Your Email Activity (last 24h)" from workplace-reporter}

### Teams Conversations
{Insert "Your Teams Activity (last 24h)" from workplace-reporter}
